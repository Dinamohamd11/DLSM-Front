...
function flip() {
  document.getElementById("dangerous").value == 1 ? (document.getElementById("dangerous").value = 0) : (document.getElementById("dangerous").value = 1);
...
function flip_Custom() {
  document.getElementById("CustomsClearness").value == 1 ? (document.getElementById("CustomsClearness").value = 0) : (document.getElementById("CustomsClearness").value = 1);
  console.log(document.getElementById("CustomsClearness").value);
}
function flip_Trucking() {
  document.getElementById("Trucking").value == 1 ? (document.getElementById("Trucking").value = 0) : (document.getElementById("Trucking").value = 1);
  console.log(document.getElementById("Trucking").value);
}
for (let i = 0; i < all.length; i++) if (!all[i].classList.contains("d-none")) all[i].classList.add("d-none");
...
function Dtrans() {
  ...
  for (let i = 0; i < all.length; i++) if (!all[i].classList.contains("d-none")) all[i].classList.add("d-none");
  for (let i = 0; i < all.length; i++) if (all[i].classList.contains(tranChoose)) all[i].classList.remove("d-none");
}
...
function SendReq() {
  if (document.getElementById("req_type").value == 1) {
    ...
    data = {
      ...
      GoodsType: document.getElementById("GoodsType").value,
      Weight: document.getElementById("Weight").value,
      Safety: document.getElementById("dangerous").value == 1 ? document.getElementById("Safety") : "   ",
      client_id: JSON.parse(localStorage.getItem("CurrentUser")).id,
    };
    const apiUrl = `${localStorage.getItem("API")}/requests-create`;
    const requestOptions = {
